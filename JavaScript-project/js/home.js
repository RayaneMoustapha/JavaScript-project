...
const product1=new products('T-shirt adidas','80 $','fashion','image/T-shirtadidas.jpg',1);
const product2=new products('earpods','150 $','Phone accessories ','image/earpods.jpg',2);
const product3=new products('Jacket','120 $','fashion','image/jacket.jpg',3);
const product4=new products('Adidas bottle','50 $','Sport','image/adidasbottle.jpg',4);
const product5=new products('Glasses','80 $','Men accessories','image/glasses.jpg',5);
const product6=new products('Cap','20 $','Men accessories','image/cap.jpg',6);
const product7=new products('Bag adidas',' 110 $','Bags','image/adidasbag.jpg',7);
const product8=new products('Shoes adidas','80 $','sport','image/adidasshoes.jpg',8);
const product9=new products('Bag','100 $','fashion','image/bag.jpg',9);
